<div class="p-6 max-w-3xl mx-auto">
    ...
    <div class="flex items-center justify-between mb-6">
        <div>
            <h1 class="text-[22px] font-extrabold text-ink">แนวทางการพิจารณาเบื้องต้น</h1>
            <p class="text-sm text-faint mt-0.5">เกณฑ์และแนวทางที่ใช้ประกอบการพิจารณาราคากลาง</p>
        </div>
    </div>
    ...
    <div class="flex flex-col gap-3 mb-6">
        ...
        @empty
            <div class="text-center py-16 text-faint">
                ...
                <div class="text-sm">ยังไม่มีแนวทางการพิจารณา</div>
            </div>
        @endforelse
    </div>
    ...
    @if ($canAdd)
        <div class="bg-surface-alt border-[1.5px] border-line rounded-xl p-4">
            ...
            <textarea wire:model="newContent" rows="3" placeholder="กรอกเนื้อหาแนวทางการพิจารณา..."
